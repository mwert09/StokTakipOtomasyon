...
CREATE TABLE `gunluk` (
  `gunlukId` int NOT NULL AUTO_INCREMENT,
  `gunlukTarih` date NOT NULL,
  PRIMARY KEY (`gunlukId`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `gunluk`
--

LOCK TABLES `gunluk` WRITE;
/*!40000 ALTER TABLE `gunluk` DISABLE KEYS */;
INSERT INTO `gunluk` VALUES (1,'2020-03-20'),(2,'2020-03-20'),(3,'2020-03-20'),(4,'2020-03-20'),(5,'2020-03-20'),(6,'2020-03-20'),(7,'2020-03-20');
